...
public class SelectionOptionsHTML
{
	...
	{		
		...
		String options = "<option value=\"" + DEFAULT + "\">-- Choose Format --</option>";
		String formatURI;
		String option = "";
		while(formats.hasNext())
		{
			formatURI = formats.nextSolution().get("?format").toString();
			option = "<option title=\"" + formatURI + "\" value=\"" + formatURI + "\">" + getURIFragment(formatURI) + "</option>";
			options += option;
		}
	...
	{		
		...
		String options = "<option value=\"" + DEFAULT + "\">-- Choose ViewerSet --</option>";
		String viewerSetURI;
		String option = "";
		while(viewerSets.hasNext())
		{
			viewerSetURI = viewerSets.nextSolution().get("?viewerSet").toString();
			option = "<option title=\"" + viewerSetURI + "\" value=\"" + viewerSetURI + "\">" + getURIFragment(viewerSetURI) + "</option>";
			options += option;
		}
	...
	{		
		...
		String options = "<option value=\"" + DEFAULT + "\">-- Choose Type --</option>";
		String typeURI;
		String label;
		String option = "";
		while(types.hasNext())
	...
	{		
		...
		String paramURI;
		String options = "<option value=\"" + DEFAULT + "\">-- Choose Parameter --</option>";
		String option = "";
		while(parameters.hasNext())
		{
			...
			{
				option = "<option title=\"" + paramURI + "\" value=\"" + paramURI + "\">" + getURIFragment(paramURI) + "</option>";
				options += option;
			}
		}
	...
	{		
		...
		String viewURI;
		String options = "<option value=\"" + DEFAULT + "\">-- Choose View --</option>";
		String option = "";
		while(views.hasNext())
		{
			viewURI = views.nextSolution().get("?view").toString();
			option = "<option title=\"" + viewURI + "\" value=\"" + viewURI + "\">" + getURIFragment(viewURI) + "</option>";
			options += option;
		}
