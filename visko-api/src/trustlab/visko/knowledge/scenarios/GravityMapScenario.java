package trustlab.visko.knowledge.scenarios;
...
import trustlab.visko.ontology.operator.writer.ViewerWriter;
...
import trustlab.visko.ontology.view.writer.ViewContourWriter;
import trustlab.visko.ontology.view.writer.ViewPointsWriter;
import trustlab.visko.ontology.view.writer.ViewRasterWriter;
...
public class GravityMapScenario {
	...
	public static void main(String[] args) {
		...
		Server ciServer = new CIServer(serverURL, serverProject, userName, password);
